...
public class SaleService {
    ...
    private final ITicketRepository normalTicketRepository;
...
//            for (TicketDTOReq ticket : saleDTOReq.getNormalTickets()) {
//                normalTickets.add(modelMapper.map(ticket, Ticket.class));
//            }
//        }
...
//        Optional<Ticket> optNormalTicket = null;
//        Optional<VipTicket> optionalVipTicket = null;
//        if (normalTickets.size() != 0) {
//            for (Ticket ticket : normalTickets) {
...
//            if (sale.getTickets().isEmpty() && sale.getVipTickets() != null) {
//                sumTotal += sale.getTotalPrice();
//                totalVipTicketsSold += sale.getVipTickets().size();
//            } else if (sale.getTickets() != null && sale.getVipTickets().isEmpty()) {
//                sumTotal += sale.getTotalPrice();
//                totalNormalTicketsSold += sale.getTickets().size();
//            } else {
//                sumTotal += sale.getTotalPrice();
//                totalNormalTicketsSold += sale.getTickets().size();
//                totalVipTicketsSold += sale.getVipTickets().size();
